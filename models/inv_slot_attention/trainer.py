...
@dataclass
class InvariantSlotAttentionTrainer(BaseTrainer):
    ...
    def param_groups(self) -> List[str]:
        return ["encoder", "decoder", "inv_slot_attention"]
    ...
    def _init_model(self):
        ...
        torch.nn.init.zeros_(self.model.inv_slot_attention.GRU.bias_ih)
        torch.nn.init.zeros_(self.model.inv_slot_attention.GRU.bias_hh)
        torch.nn.init.orthogonal_(self.model.inv_slot_attention.GRU.weight_hh)
